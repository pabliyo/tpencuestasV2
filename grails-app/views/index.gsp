...
<div id="content" role="main"
     style="background-image:url('${resource(dir: "images", file: "fondo3.jpg")}');height: 500px;width:1300px;">
    <section class="row colset-2-its">
        <h1 align="center">Bienvenido a Question</h1>

        <div id="controllers" role="navigation">
            <sec:ifAnyGranted roles='ROLE_ADMIN'>
                <h1 align="left"><b>Administracion:</b></h1>
                <ul>
                    <li>
            ...
            <sec:ifLoggedIn>
                ...
                <ul>
                    ...
                    <div class="pagination">
                        <li>
                            <g:link controller="participacion"
                                    action="show">Participar en encuestas disponibles</g:link>
                        </li>
                    </div>
