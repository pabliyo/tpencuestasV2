    ...
    <body>
        ...
        <div id="edit-usuario" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.usuario}" method="PUT">
                ...
                <fieldset class="form">
                    <f:field bean="usuario" property="username" value="${this.usuario.username}" ><f:display bean="usuario" property="username"/></f:field>
                    <f:field bean="usuario" property="password"/>
                    <f:field bean="usuario" property="email"/>
                    <f:field bean="usuario" property="cuentaPremium" value="${this.usuario.cuentaPremium}" ><f:display bean="usuario" type="checkbox" property="cuentaPremium"/></f:field>
                </fieldset>
